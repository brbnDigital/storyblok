...
async function GenerateTypes(options) {
    ...
    async function GetAllComponentGroups() {
        let request = await client_1.client.get(`spaces/${variables_1.SPACE_ID}/component_groups`);
    ...
    async function GetAllComponents() {
        let request = await client_1.client.get(`spaces/${variables_1.SPACE_ID}/components`);
